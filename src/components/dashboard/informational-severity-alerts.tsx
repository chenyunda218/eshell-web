...
const InformationalServerityAlerts: React.FC = () => {
  ...
  return (
    <Container
      style={{
        borderRadius: 5,
        padding: 5,
        backgroundColor: "#4451cc",
        margin: 5,
        color: "white",
      }}
      loading={isLoading}>
      <Decimal title="Informational Severity Alerts" value={value} />
    </Container>
  );
};

export default InformationalServerityAlerts;
