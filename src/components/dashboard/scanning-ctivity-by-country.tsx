...
const columns = [
  {
    title: "Top 5 values of destination.geo.country_name",
    dataIndex: "country",
  },
  {
    title: "Count",
...
const ScanningActivityByCountry = () => {
  const [isLoading, setIsLoading] = React.useState<boolean>(false);
  const [data, setData] = React.useState<{ country: string; count: number }[]>(
    []
  );
  ...
  return (
    <Container
      title="Scanning Activity (Many Attacks from Same Source) by Country"
      loading={isLoading}>
...
export default ScanningActivityByCountry;
